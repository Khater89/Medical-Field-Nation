...
• الوقت الإضافي: يُحتسب بنسبة 10% من السعر الأساسي عن كل 15 دقيقة إضافية بعد الساعة الأولى وفق سياسة المنصة المعتمدة.
...
const BookingDetailsDrawer = ({ booking, open, onOpenChange, serviceName, servicePrice, serviceCategory, providerName, providerPhone, onStatusChange, onDataRefresh }: Props) => {
